...
> Usar o aplicativo do ZecaUrubank para smartphones; <br>

> Contratar ou usar qualquer um dos nossos produtos ou serviços, seja  
fazendo compras com o seu cartão de crédito ou transações com a sua conta do ZecaUrubank; <br>

> Entrar em contato conosco pelos nossos canais de atendimento; <br>

> Participar de pesquisas ou promoções realizadas pelo ZecaUrubank.
...
> Endereço IP do dispositivo móvel utilizado para acessar os serviços ou produtos do ZecaUrubank; <br>

> Interações realizadas e perfil de uso do aplicativo do ZecaUrubank; <br>
...
> Dados de contratação de nossos produtos e serviços, tais como cartão de crédito; <br>

> Dados de transações e movimentações financeiras na conta do ZecaUrubank, como débitos, saques, pagamentos 
...
> Informações sobre menções ou interações com o ZecaUrubank; <br>
 
> Depoimentos referentes ao ZecaUrubank postados em perfis e páginas nas redes sociais, juntamente com seu nome e imagem (incluindo fotos de perfil).

## Como o ZecaUrubank usa seus dados pessoais

O ZecaUrubank utiliza os seus dados pessoais para poder prestar um serviço de alta 
qualidade e oferecer os melhores produtos a você. 
...
> Identificação, autenticação e verificação de requisitos para contratação dos serviços e produtos do ZecaUrubank;
 
> Autenticação de transações financeiras;

> Atendimento de solicitações e dúvidas;

> Efetivação de portabilidade salarial, se requerida;

> Contato por telefone, e-mail, SMS, WhatsApp, ou outros meios de comunicação, inclusive para envio de notificações ou push de uso dos serviços do ZecaUrubank;

> Envio do seu cartão de crédito e comunicações em geral;

> Envio de WOW (um presente, uma carta ou um mimo que pode ser enviada quando há uma conexão entre cliente e o atendimento do ZecaUrubank);

> Aprimoramento dos serviços prestados pelo ZecaUrubank, inclusive com o cruzamento de informações sobre produtos contratados por pessoa física e por pessoa jurídica para oferecimento de novos produtos e serviços;

> Consultas sobre suas informações na base de dados do Sistema de Informações de Crédito (SCR), mediante a obtenção do seu consentimento com esse uso;

> Reavaliações periódicas sobre a elegibilidade para ser um cliente do ZecaUrubank, possibilitando o eventual convite proativo a prospectos;
...
> Investigações e medidas de prevenção e combate a ilícitos, fraudes, crimes financeiros e garantia da segurança dos clientes do ZecaUrubank e do sistema financeiro;
 
> Exercício regular de direitos do ZecaUrubank, inclusive apresentando documentos em processos judiciais e administrativos, se necessário;
...
> Prevenção à fraude e garantia da sua segurança nos processos de identificação e autenticação de cadastro e de novo dispositivo.

### Dados pessoais que coletamos de terceiros

Finalidades:

> Melhoria de nossos produtos e serviços; <br>
 
> Marketing, prospecção, pesquisas de mercado e de opinião; <br>

> Reavaliações periódicas sobre a elegibilidade para ser um cliente do ZecaUrubank, possibilitando o eventual convite proativo a prospectos; <br>

> Cumprimento de obrigação legal ou regulatória, por exemplo, para manutenção do seu cadastro atualizado ou cumprimento de obrigações legais e/ou regulatórias impostas ao ZecaUrubank, incluindo normas de Conheça seu Cliente, Prevenção à Lavagem de Dinheiro e Financiamento ao Terrorismo e outras.

### Dados de navegação e do dispositivo

Finalidades:

> Prestação dos serviços, oferecimento dos produtos contratados e aperfeiçoamento do uso e experiência com o aplicativo do ZecaUrubank; <br>

> Operacionalização de novos produtos e serviços; <br>

> Recomendação de novos serviços, produtos ou funcionalidades do aplicativo, inclusive serviços de parceiros que possam te interessar; <br>

> Exibição de publicidade, seja no nosso site, redes sociais ou em sites de terceiros; <br>

> Geração de estatísticas, estudos, pesquisas e levantamentos pertinentes às atividades e comportamento no uso dos produtos ou serviços; <br>

> Dados de geolocalização para sua segurança - por exemplo, identificando compras indevidas; <br>

> Exercício regular de direitos do ZecaUrubank, inclusive apresentando documentos em processos judiciais e administrativos, se necessário; <br>
...
> Divulgação dos produtos e serviços prestados pelo ZecaUrubank em redes sociais, websites, aplicativos ou materiais institucionais e publicitários; <br>

> Envio de WOW (um presente, uma carta ou um mimo que pode ser enviada quando há uma conexão entre cliente e o atendimento do ZecaUrubank); <br>

> Proteção ao crédito, incluindo concessão de crédito e aumento de limite; <br>

> Investigações e medidas de prevenção e combate a ilícitos, fraudes, crimes financeiros e garantia da segurança dos clientes do ZecaUrubank e do sistema financeiro; <br>

> Exercício regular de direitos do ZecaUrubank.

## Compartilhamento de dados pessoais

O ZecaUrubank poderá compartilhar os seus dados caso você solicite. O compartilhamento dos seus dados também poderá ser feito com empresas do grupo econômico do ZecaUrubank, com terceiros parceiros e com autoridades e órgãos reguladores para diferentes finalidades, quando necessário.
Sempre que efetuado, o compartilhamento de dados será realizado dentro dos limites e propósitos dos nossos negócios e de acordo com o que autoriza a legislação aplicável.

As Finalidades do compartilhamento estão referidas nos tópicos de Dados Públicos e nos Dados coletados de terceiros.
...
> Cumprimento de ordem judicial,atendimento de solicitação de autoridade competente ou órgão fiscalizador; <br>
...
> Você pode solicitar que o ZecaUrubank informe e forneça os dados pessoais que possui em relação a você.

#### Correção de dados pessoais incompletos, inexatos ou desatualizados

> Se você verificar que os seus dados pessoais estão incompletos, inexatos ou desatualizados, você pode pedir a correção ou complementação ao ZecaUrubank. Para isso, caso não seja possível realizar a alteração pelo próprio aplicativo do ZecaUrubank, você precisará enviar um documento que comprove a forma correta e atual do dado pessoal.

### Anonimização, bloqueio ou eliminação de dados desnecessários, excessivos ou tratados em desconformidade com a LGPD

> Caso qualquer dado pessoal seja tratado de forma desnecessária, em excesso para a finalidade a que se destina ou em desconformidade com a LGPD, você pode solicitar que o ZecaUrubank anonimize, bloqueie ou elimine esses dados, desde que fique efetivamente constatado o excesso, a falta de necessidade ou a desconformidade com a lei.
...
### Informação das empresas com as quais o ZecaUrubank compartilhou ou das quais recebeu seus dados pessoais

> Você pode solicitar que o ZecaUrubank informe com quais terceiros compartilhou ou de quem recebeu seus dados pessoais.
